...
namespace Personel_Giriş_Çıkış
{
    public partial class frmPersonelGirisi : Form
    {
        ...
        private void FrmPersonelGirisi_Load(object sender, EventArgs e)
        {
            ...
            //combobox
            cmbAdiSoyadi.DataSource = tablo;
            cmbAdiSoyadi.ValueMember = "ID";//personel id
            cmbAdiSoyadi.DisplayMember = "ADISOYADI";//personel ad
        ...
        private void BtnGiris_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            SQLiteCommand cmd = conn.CreateCommand();
            cmd.CommandText = "SELECT * FROM tblgiriscikis where ID='" + cmbAdiSoyadi.SelectedValue + "'";
            ...
            {
                string sql1 = "UPDATE tblgiriscikis SET  DEGER='0', GIRIS='" + zaman.ToString() + "', CIKIS='Çıkış yapmadı' WHERE ID='" + cmbAdiSoyadi.SelectedValue + "'";
                ...
                MessageBox.Show("HOŞGELDİNİZ "+ ad, "UYARI", MessageBoxButtons.OK, MessageBoxIcon.Information);
